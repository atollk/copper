...
template bool buffered_channel<std::unique_ptr<int>>::try_push_until(
    std::unique_ptr<int>&&,
    const std::chrono::time_point<std::chrono::system_clock>&);
template copper::channel_op_status buffered_channel<std::unique_ptr<int>>::pop_func(
    std::function<void(std::unique_ptr<int>)>&);
template copper::channel_op_status buffered_channel<std::unique_ptr<int>>::try_pop_func(
    std::function<void(std::unique_ptr<int>)>&);
template copper::channel_op_status buffered_channel<std::unique_ptr<int>>::try_pop_func_for(
    std::function<void(std::unique_ptr<int>)>&,
    const std::chrono::duration<int>&);
template copper::channel_op_status buffered_channel<std::unique_ptr<int>>::try_pop_func_until(
    std::function<void(std::unique_ptr<int>)>&,
    const std::chrono::time_point<std::chrono::system_clock>&);
template copper::channel_op_status buffered_channel<std::unique_ptr<int>>::push_func(
    std::function<std::unique_ptr<int>()>&);
template copper::channel_op_status buffered_channel<std::unique_ptr<int>>::try_push_func(
    std::function<std::unique_ptr<int>()>&);
template copper::channel_op_status buffered_channel<std::unique_ptr<int>>::try_push_func_for(
    std::function<std::unique_ptr<int>()>&,
    const std::chrono::duration<int>&);
...
template bool unbuffered_channel<std::unique_ptr<int>>::try_push_until(
    std::unique_ptr<int>&&,
    const std::chrono::time_point<std::chrono::system_clock>&);
template copper::channel_op_status unbuffered_channel<std::unique_ptr<int>>::pop_func(
    std::function<void(std::unique_ptr<int>)>&);
...
template copper::channel_op_status unbuffered_channel<std::unique_ptr<int>>::try_pop_func_until(
    std::function<void(std::unique_ptr<int>)>&,
    const std::chrono::time_point<std::chrono::system_clock>&);
template copper::channel_op_status unbuffered_channel<std::unique_ptr<int>>::push_func(
    std::function<std::unique_ptr<int>()>&);
template copper::channel_op_status unbuffered_channel<std::unique_ptr<int>>::try_push_func(
    std::function<std::unique_ptr<int>()>&);
