...
IMPORTANT: The channel object is locked while the callable is executed.
If computing the pushed message or handling the popped message is expensive, you might block other threads trying to access the channel.
In that case, it can be better to pre-compute the value.
...
IMPORTANT: The channel object is locked while a callable is executed.
If computing the pushed message or handling the popped message is expensive, you might block other threads trying to access the channel.
In that case, it can be better to pre-compute the value.
